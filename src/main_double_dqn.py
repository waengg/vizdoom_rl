...
if __name__ == "__main__":
    ...
    dql = DeepQNetwork(dims, n_actions, frames_per_state=frames_per_state, training=True, dueling=False)
    dql_target = DeepQNetwork(dims, n_actions, frames_per_state=frames_per_state, training=True, dueling=False)
